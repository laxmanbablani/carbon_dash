...
#' @export
expandableSearch <- function(children=NULL, id=NULL, autoComplete=NULL, className=NULL, closeButtonLabelText=NULL, debounce=NULL, defaultValue=NULL, disabled=NULL, isExpanded=NULL, labelText=NULL, light=NULL, loading_state=NULL, n_blur=NULL, n_submit=NULL, onChange=NULL, onClear=NULL, onExpand=NULL, onKeyDown=NULL, persisted_props=NULL, persistence=NULL, persistence_type=NULL, placeholder=NULL, renderIcon=NULL, role=NULL, size=NULL, style=NULL, type=NULL, value=NULL) {
