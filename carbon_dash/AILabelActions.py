...
class AILabelActions(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AILabelActions, self).__init__(children=children, **args)

setattr(AILabelActions, "__init__", _explicitize_args(AILabelActions.__init__))
