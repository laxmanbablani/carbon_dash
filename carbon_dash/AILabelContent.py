...
class AILabelContent(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AILabelContent, self).__init__(children=children, **args)

setattr(AILabelContent, "__init__", _explicitize_args(AILabelContent.__init__))
