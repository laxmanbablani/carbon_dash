...
class AISkeletonPlaceholder(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(AISkeletonPlaceholder, self).__init__(children=children, **args)

setattr(AISkeletonPlaceholder, "__init__", _explicitize_args(AISkeletonPlaceholder.__init__))
