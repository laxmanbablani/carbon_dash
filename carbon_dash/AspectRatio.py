...
- ratio (boolean | number | string | dict | list; optional):
    ratio."""
    ...
    def __init__(
        ...
        ratio: typing.Optional[typing.Any] = None,
        **kwargs
    ):
        self._prop_names = ['children', 'id', 'as_', 'className', 'loading_state', 'ratio', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'as_', 'className', 'loading_state', 'ratio', 'style']
