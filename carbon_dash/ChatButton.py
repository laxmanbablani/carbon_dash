...
- isQuickAction (boolean | number | string | dict | list; optional):
    isQuickAction.
...
- size (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'disabled', 'isQuickAction', 'isSelected', 'kind', 'loading_state', 'renderIcon', 'size', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'disabled', 'isQuickAction', 'isSelected', 'kind', 'loading_state', 'renderIcon', 'size', 'style']
        ...
        super(ChatButton, self).__init__(children=children, **args)

setattr(ChatButton, "__init__", _explicitize_args(ChatButton.__init__))
