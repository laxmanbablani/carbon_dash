...
class CheckboxSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(CheckboxSkeleton, self).__init__(children=children, **args)

setattr(CheckboxSkeleton, "__init__", _explicitize_args(CheckboxSkeleton.__init__))
