...
- tagName (boolean | number | string | dict | list; optional):
    tagName."""
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'loading_state', 'style', 'tagName']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'loading_state', 'style', 'tagName']
