...
- onClick (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'align', 'autoAlign', 'className', 'feedback', 'feedbackTimeout', 'iconDescription', 'loading_state', 'onClick', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'align', 'autoAlign', 'className', 'feedback', 'feedbackTimeout', 'iconDescription', 'loading_state', 'onClick', 'style']
