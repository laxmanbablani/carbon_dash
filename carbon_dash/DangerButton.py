...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(DangerButton, self).__init__(children=children, **args)

setattr(DangerButton, "__init__", _explicitize_args(DangerButton.__init__))
