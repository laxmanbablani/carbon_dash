...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'fallback', 'loading_state', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'fallback', 'loading_state', 'style']
...
setattr(ErrorBoundary, "__init__", _explicitize_args(ErrorBoundary.__init__))
