...
class ErrorBoundaryContext(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ErrorBoundaryContext, self).__init__(children=children, **args)

setattr(ErrorBoundaryContext, "__init__", _explicitize_args(ErrorBoundaryContext.__init__))
