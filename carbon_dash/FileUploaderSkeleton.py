...
class FileUploaderSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FileUploaderSkeleton, self).__init__(children=children, **args)

setattr(FileUploaderSkeleton, "__init__", _explicitize_args(FileUploaderSkeleton.__init__))
