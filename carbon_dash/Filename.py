...
- tabIndex (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'iconDescription', 'invalid', 'loading_state', 'name', 'status', 'style', 'tabIndex']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'iconDescription', 'invalid', 'loading_state', 'name', 'status', 'style', 'tabIndex']
        ...
        super(Filename, self).__init__(children=children, **args)

setattr(Filename, "__init__", _explicitize_args(Filename.__init__))
