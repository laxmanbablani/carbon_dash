...
class FluidComboBoxSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidComboBoxSkeleton, self).__init__(children=children, **args)

setattr(FluidComboBoxSkeleton, "__init__", _explicitize_args(FluidComboBoxSkeleton.__init__))
