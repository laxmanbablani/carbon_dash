...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional)"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidDatePicker, self).__init__(children=children, **args)

setattr(FluidDatePicker, "__init__", _explicitize_args(FluidDatePicker.__init__))
