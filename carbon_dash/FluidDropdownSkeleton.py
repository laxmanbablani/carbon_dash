...
class FluidDropdownSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidDropdownSkeleton, self).__init__(children=children, **args)

setattr(FluidDropdownSkeleton, "__init__", _explicitize_args(FluidDropdownSkeleton.__init__))
