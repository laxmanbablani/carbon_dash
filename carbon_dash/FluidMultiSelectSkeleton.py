...
class FluidMultiSelectSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    _type = 'FluidMultiSelectSkeleton'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidMultiSelectSkeleton, self).__init__(children=children, **args)

setattr(FluidMultiSelectSkeleton, "__init__", _explicitize_args(FluidMultiSelectSkeleton.__init__))
