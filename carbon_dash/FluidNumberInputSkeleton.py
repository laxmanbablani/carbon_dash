...
class FluidNumberInputSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    _type = 'FluidNumberInputSkeleton'
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidNumberInputSkeleton, self).__init__(children=children, **args)

setattr(FluidNumberInputSkeleton, "__init__", _explicitize_args(FluidNumberInputSkeleton.__init__))
