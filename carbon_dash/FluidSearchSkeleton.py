...
class FluidSearchSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidSearchSkeleton, self).__init__(children=children, **args)

setattr(FluidSearchSkeleton, "__init__", _explicitize_args(FluidSearchSkeleton.__init__))
