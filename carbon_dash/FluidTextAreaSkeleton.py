...
class FluidTextAreaSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidTextAreaSkeleton, self).__init__(children=children, **args)

setattr(FluidTextAreaSkeleton, "__init__", _explicitize_args(FluidTextAreaSkeleton.__init__))
