...
class FluidTextInputSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidTextInputSkeleton, self).__init__(children=children, **args)

setattr(FluidTextInputSkeleton, "__init__", _explicitize_args(FluidTextInputSkeleton.__init__))
