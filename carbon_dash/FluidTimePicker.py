...
- warnText (a list of or a singular dash component, string or number; optional):
    ...
    warning state."""
    _children_props: typing.List[str] = ['labelText', 'invalidText', 'warnText']
    _base_nodes = ['labelText', 'invalidText', 'warnText', 'children']
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'disabled', 'invalid', 'invalidText', 'labelText', 'loading_state', 'persisted_props', 'persistence', 'persistence_type', 'style', 'warn', 'warnText']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'disabled', 'invalid', 'invalidText', 'labelText', 'loading_state', 'persisted_props', 'persistence', 'persistence_type', 'style', 'warn', 'warnText']
