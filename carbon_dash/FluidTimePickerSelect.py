...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional)"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(FluidTimePickerSelect, self).__init__(children=children, **args)

setattr(FluidTimePickerSelect, "__init__", _explicitize_args(FluidTimePickerSelect.__init__))
