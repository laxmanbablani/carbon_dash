...
- theme (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'loading_state', 'style', 'theme']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'loading_state', 'style', 'theme']
...
setattr(GlobalTheme, "__init__", _explicitize_args(GlobalTheme.__init__))
