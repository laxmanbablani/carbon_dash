...
- n_clicks (number; default 0)"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(HeaderGlobalAction, self).__init__(children=children, **args)

setattr(HeaderGlobalAction, "__init__", _explicitize_args(HeaderGlobalAction.__init__))
