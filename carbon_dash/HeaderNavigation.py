...
class HeaderNavigation(Component):
...
- loading_state (dict; optional)
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(HeaderNavigation, self).__init__(children=children, **args)

setattr(HeaderNavigation, "__init__", _explicitize_args(HeaderNavigation.__init__))
