...
- hasForm (boolean | number | string | dict | list; optional):
    hasForm.
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        hasForm: typing.Optional[typing.Any] = None,
        hasScrollingContent: typing.Optional[typing.Any] = None,
        **kwargs
    ):
        self._prop_names = ['children', 'id', 'className', 'hasForm', 'hasScrollingContent', 'loading_state', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'hasForm', 'hasScrollingContent', 'loading_state', 'style']
