...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ModalPresence, self).__init__(children=children, **args)

setattr(ModalPresence, "__init__", _explicitize_args(ModalPresence.__init__))
