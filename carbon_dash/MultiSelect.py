...
- warnText (a list of or a singular dash component, string or number; optional)"""
    _children_props: typing.List[str] = ['label', 'helperText', 'titleText', 'invalidText', 'warnText']
    _base_nodes = ['label', 'helperText', 'titleText', 'invalidText', 'warnText', 'children']
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'disabled', 'helperText', 'invalid', 'invalidText', 'items', 'label', 'loading_state', 'persisted_props', 'persistence', 'persistence_type', 'selectedItems', 'size', 'style', 'titleText', 'warn', 'warnText']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'disabled', 'helperText', 'invalid', 'invalidText', 'items', 'label', 'loading_state', 'persisted_props', 'persistence', 'persistence_type', 'selectedItems', 'size', 'style', 'titleText', 'warn', 'warnText']
