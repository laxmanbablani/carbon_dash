...
class NotificationButton(Component):
...
- type (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'loading_state', 'name', 'notificationType', 'renderIcon', 'style', 'type']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'loading_state', 'name', 'notificationType', 'renderIcon', 'style', 'type']
        ...
        super(NotificationButton, self).__init__(children=children, **args)

setattr(NotificationButton, "__init__", _explicitize_args(NotificationButton.__init__))
