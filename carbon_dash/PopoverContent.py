...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PopoverContent, self).__init__(children=children, **args)

setattr(PopoverContent, "__init__", _explicitize_args(PopoverContent.__init__))
