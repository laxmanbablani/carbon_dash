...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(PrefixContext, self).__init__(children=children, **args)

setattr(PrefixContext, "__init__", _explicitize_args(PrefixContext.__init__))
