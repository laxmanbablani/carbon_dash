...
class RadioButtonSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(RadioButtonSkeleton, self).__init__(children=children, **args)

setattr(RadioButtonSkeleton, "__init__", _explicitize_args(RadioButtonSkeleton.__init__))
