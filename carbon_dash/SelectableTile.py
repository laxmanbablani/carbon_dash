...
- value (boolean | number | string | dict | list; default ''):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SelectableTile, self).__init__(children=children, **args)

setattr(SelectableTile, "__init__", _explicitize_args(SelectableTile.__init__))
