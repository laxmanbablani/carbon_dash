...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.available_properties = ['children', 'id', 'className', 'isSideNavExpanded', 'loading_state', 'style']
        ...
        super(SideNavItems, self).__init__(children=children, **args)

setattr(SideNavItems, "__init__", _explicitize_args(SideNavItems.__init__))
