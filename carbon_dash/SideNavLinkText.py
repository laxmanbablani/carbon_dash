...
class SideNavLinkText(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SideNavLinkText, self).__init__(children=children, **args)

setattr(SideNavLinkText, "__init__", _explicitize_args(SideNavLinkText.__init__))
