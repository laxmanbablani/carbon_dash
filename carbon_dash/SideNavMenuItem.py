...
- n_clicks (number; default 0)"""
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SideNavMenuItem, self).__init__(children=children, **args)

setattr(SideNavMenuItem, "__init__", _explicitize_args(SideNavMenuItem.__init__))
