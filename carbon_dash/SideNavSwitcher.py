...
- loading_state (dict; optional)
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SideNavSwitcher, self).__init__(children=children, **args)

setattr(SideNavSwitcher, "__init__", _explicitize_args(SideNavSwitcher.__init__))
