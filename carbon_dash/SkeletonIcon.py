...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(SkeletonIcon, self).__init__(children=children, **args)

setattr(SkeletonIcon, "__init__", _explicitize_args(SkeletonIcon.__init__))
