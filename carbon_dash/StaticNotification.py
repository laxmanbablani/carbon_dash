...
class StaticNotification(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(StaticNotification, self).__init__(children=children, **args)

setattr(StaticNotification, "__init__", _explicitize_args(StaticNotification.__init__))
