...
class StructuredListHead(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(StructuredListHead, self).__init__(children=children, **args)

setattr(StructuredListHead, "__init__", _explicitize_args(StructuredListHead.__init__))
