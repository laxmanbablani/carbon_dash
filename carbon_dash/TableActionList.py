...
class TableActionList(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TableActionList, self).__init__(children=children, **args)

setattr(TableActionList, "__init__", _explicitize_args(TableActionList.__init__))
