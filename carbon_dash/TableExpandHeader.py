...
class TableExpandHeader(Component):
...
- enableExpando (boolean | number | string | dict | list; optional):
    enableExpando.

- enableToggle (boolean | number | string | dict | list; optional):
    enableToggle.
...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TableExpandHeader, self).__init__(children=children, **args)

setattr(TableExpandHeader, "__init__", _explicitize_args(TableExpandHeader.__init__))
