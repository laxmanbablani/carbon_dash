...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'expandHeader', 'expandIconDescription', 'isExpanded', 'isSelected', 'loading_state', 'onExpand', 'persisted_props', 'persistence', 'persistence_type', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'expandHeader', 'expandIconDescription', 'isExpanded', 'isSelected', 'loading_state', 'onExpand', 'persisted_props', 'persistence', 'persistence_type', 'style']
