...
- onExpand (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'className', 'isExpanded', 'isSelected', 'loading_state', 'onExpand', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'className', 'isExpanded', 'isSelected', 'loading_state', 'onExpand', 'style']
...
setattr(TableRow, "__init__", _explicitize_args(TableRow.__init__))
