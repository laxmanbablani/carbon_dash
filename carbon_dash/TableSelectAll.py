...
class TableSelectAll(Component):
...
- persistence_type (a value equal to: 'local', 'session', 'memory'; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'checked', 'className', 'debounce', 'disabled', 'indeterminate', 'loading_state', 'n_blur', 'n_submit', 'name', 'onSelect', 'persisted_props', 'persistence', 'persistence_type', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'checked', 'className', 'debounce', 'disabled', 'indeterminate', 'loading_state', 'n_blur', 'n_submit', 'name', 'onSelect', 'persisted_props', 'persistence', 'persistence_type', 'style']
        ...
        super(TableSelectAll, self).__init__(children=children, **args)

setattr(TableSelectAll, "__init__", _explicitize_args(TableSelectAll.__init__))
