...
class TableSelectRow(Component):
...
- radio (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'checked', 'className', 'debounce', 'disabled', 'loading_state', 'n_blur', 'n_submit', 'name', 'onChange', 'onSelect', 'persisted_props', 'persistence', 'persistence_type', 'radio', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'checked', 'className', 'debounce', 'disabled', 'loading_state', 'n_blur', 'n_submit', 'name', 'onChange', 'onSelect', 'persisted_props', 'persistence', 'persistence_type', 'radio', 'style']
        ...
        super(TableSelectRow, self).__init__(children=children, **args)

setattr(TableSelectRow, "__init__", _explicitize_args(TableSelectRow.__init__))
