...
- selectedIndex (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self.available_properties = ['children', 'id', 'className', 'defaultSelectedIndex', 'height', 'loading_state', 'onChange', 'selectedIndex', 'style']
        ...
        super(TabsVertical, self).__init__(children=children, **args)

setattr(TabsVertical, "__init__", _explicitize_args(TabsVertical.__init__))
