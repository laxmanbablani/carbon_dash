...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ThemeContext, self).__init__(children=children, **args)

setattr(ThemeContext, "__init__", _explicitize_args(ThemeContext.__init__))
