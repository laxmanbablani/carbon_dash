...
- slug (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'decorator', 'hasRoundedCorners', 'light', 'loading_state', 'slug', 'style']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'decorator', 'hasRoundedCorners', 'light', 'loading_state', 'slug', 'style']
        ...
        super(Tile, self).__init__(children=children, **args)

setattr(Tile, "__init__", _explicitize_args(Tile.__init__))
