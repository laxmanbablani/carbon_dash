...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(TileAboveTheFoldContent, self).__init__(children=children, **args)

setattr(TileAboveTheFoldContent, "__init__", _explicitize_args(TileAboveTheFoldContent.__init__))
