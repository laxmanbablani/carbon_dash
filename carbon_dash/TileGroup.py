...
- legend (boolean | number | string | dict | list; optional):
    legend.
...
- valueSelected (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'className', 'defaultSelected', 'disabled', 'legend', 'loading_state', 'name', 'onChange', 'required', 'style', 'valueSelected']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'className', 'defaultSelected', 'disabled', 'legend', 'loading_state', 'name', 'onChange', 'required', 'style', 'valueSelected']
        ...
        super(TileGroup, self).__init__(children=children, **args)

setattr(TileGroup, "__init__", _explicitize_args(TileGroup.__init__))
