...
class ToastNotification(Component):
...
- timeout (boolean | number | string | dict | list; optional):
    timeout.
...
- title (boolean | number | string | dict | list; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        self._prop_names = ['children', 'id', 'ariaLabel', 'caption', 'className', 'hideCloseButton', 'kind', 'loading_state', 'lowContrast', 'onClose', 'onCloseButtonClick', 'role', 'statusIconDescription', 'style', 'subtitle', 'timeout', 'title']
        self._valid_wildcard_attributes =            []
        self.available_properties = ['children', 'id', 'ariaLabel', 'caption', 'className', 'hideCloseButton', 'kind', 'loading_state', 'lowContrast', 'onClose', 'onCloseButtonClick', 'role', 'statusIconDescription', 'style', 'subtitle', 'timeout', 'title']
        ...
        super(ToastNotification, self).__init__(children=children, **args)

setattr(ToastNotification, "__init__", _explicitize_args(ToastNotification.__init__))
