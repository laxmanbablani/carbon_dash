...
class ToggleSkeleton(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ToggleSkeleton, self).__init__(children=children, **args)

setattr(ToggleSkeleton, "__init__", _explicitize_args(ToggleSkeleton.__init__))
