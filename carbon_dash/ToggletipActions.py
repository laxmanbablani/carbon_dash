...
class ToggletipActions(Component):
...
- loading_state (dict; optional):
    ...
    def __init__(
        ...
        **kwargs
        ...
        super(ToggletipActions, self).__init__(children=children, **args)

setattr(ToggletipActions, "__init__", _explicitize_args(ToggletipActions.__init__))
