...
stories_dict['node-datatable'] = html.Div([
        ...
        carbon_dash.DataTable(rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}], headers=[{'key': 'name', 'header': 'Name'}, {'key': 'status', 'header': 'Status'}]),
        html.H3("AILabelWithRadioSelection"),
        carbon_dash.DataTable(radio=True, rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}], headers=[{'key': 'name', 'header': 'Name'}, {'key': 'status', 'header': 'Status'}]),
        html.H3("AILabelWithSelectionAndExpansion"),
        carbon_dash.DataTable(rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}], headers=[{'key': 'name', 'header': 'Name'}, {'key': 'status', 'header': 'Status'}]),
        html.H3("AILabelWithExpansion"),
        carbon_dash.DataTable(rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}], headers=[{'key': 'name', 'header': 'Name'}, {'key': 'status', 'header': 'Status'}]),
        html.H3("ColumnAILabelWithSelectionAndExpansion"),
        carbon_dash.DataTable(headers=[{'key': 'name', 'header': 'Name'}, {'key': 'protocol', 'header': 'Protocol'}, {'key': 'port', 'header': 'Port'}, {'key': 'rule', 'header': 'Rule'}, {'key': 'attached_groups', 'header': 'Attached groups'}, {'key': 'status', 'header': 'Status'}], rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}]),
        ...
        carbon_dash.DataTable(isSortable=True, rows=[{'id': 'a', 'name': 'Load Balancer 3', 'status': 'Disabled'}, {'id': 'b', 'name': 'Load Balancer 1', 'status': 'Starting'}], headers=[{'key': 'name', 'header': 'Name'}, {'key': 'status', 'header': 'Status'}]),
...
stories_dict['node-fileuploader'] = html.Div([
        ...
        carbon_dash.FileUploaderDropContainer(labelText='Drag and drop files here or click to upload', multiple=True, accept=['image/jpeg', 'image/png'], disabled=False, name=''),
...
stories_dict['node-overflowmenu'] = html.Div([
        ...
        html.H3("Nested"),
        carbon_dash.FeatureFlags(flags={'enable-v12-overflowmenu': True, 'enable-v12-dynamic-floating-styles': False}, children=carbon_dash.OverflowMenu(children=[carbon_dash.MenuItem(label='Level 1'), carbon_dash.MenuItem(label='Level 1'), carbon_dash.MenuItem(label='Level 1', children=[carbon_dash.MenuItem(label='Level 2', children=[carbon_dash.MenuItem(label='Level 3'), carbon_dash.MenuItem(label='Level 3', children=carbon_dash.MenuItem(label='Level 4'))]), carbon_dash.MenuItem(label='Level 2'), carbon_dash.MenuItem(label='Level 2')]), carbon_dash.MenuItem(label='Level 1')])),
        html.H3("WithMenuAlignment"),
...
stories_dict['node-tile'] = html.Div([
        ...
        html.H3("Radio"),
        carbon_dash.TileGroup(defaultSelected='default-selected', legend='Radio Tile Group', name='radio tile group', children=[carbon_dash.RadioTile(id='radio-tile-1', value='standard', style={'marginBottom': '.5rem'}, children='Option 1'), carbon_dash.RadioTile(id='radio-tile-2', value='default-selected', style={'marginBottom': '.5rem'}, children='Option 2'), carbon_dash.RadioTile(id='radio-tile-3', value='selected', children='Option 3')]),
