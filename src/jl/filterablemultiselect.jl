...
"""
    filterablemultiselect(;kwargs...)
    filterablemultiselect(children::Any;kwargs...)
    filterablemultiselect(children_maker::Function;kwargs...)
...
- `filterItems` (Bool | Real | String | Dict | Array; optional): filterItems
...
"""
function filterablemultiselect(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("filterablemultiselect", "FilterableMultiSelect", "carbon_dash", available_props, wild_props; kwargs...)
end

filterablemultiselect(children::Any; kwargs...) = filterablemultiselect(;kwargs..., children = children)
filterablemultiselect(children_maker::Function; kwargs...) = filterablemultiselect(children_maker(); kwargs...)
