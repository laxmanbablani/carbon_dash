...
"""
    fluidcombobox(;kwargs...)
    fluidcombobox(children::Any;kwargs...)
    fluidcombobox(children_maker::Function;kwargs...)
...
"""
function fluidcombobox(; kwargs...)
        available_props = Symbol[:children, :id, :className, :direction, :disabled, :initialSelectedItem, :invalid, :invalidText, :isCondensed, :itemToElement, :itemToString, :items, :label, :loading_state, :onChange, :selectedItem, :style, :titleText, :translateWithId, :warn, :warnText]
        wild_props = Symbol[]
        return Component("fluidcombobox", "FluidComboBox", "carbon_dash", available_props, wild_props; kwargs...)
end

fluidcombobox(children::Any; kwargs...) = fluidcombobox(;kwargs..., children = children)
fluidcombobox(children_maker::Function; kwargs...) = fluidcombobox(children_maker(); kwargs...)
