...
"""
    slug(;kwargs...)
    slug(children::Any;kwargs...)
    slug(children_maker::Function;kwargs...)


A Slug component.
Slug is a wrapper for the Carbon Slug component.
Keyword arguments:
...
function slug(; kwargs...)
        ...
        wild_props = Symbol[]
        return Component("slug", "Slug", "carbon_dash", available_props, wild_props; kwargs...)
end

slug(children::Any; kwargs...) = slug(;kwargs..., children = children)
slug(children_maker::Function; kwargs...) = slug(children_maker(); kwargs...)
