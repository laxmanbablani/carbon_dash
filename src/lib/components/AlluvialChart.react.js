...
import { AlluvialChart as CarbonChart } from '@carbon/charts';
...
const AlluvialChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('alluvial-node-click', (event) => {
...
AlluvialChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
