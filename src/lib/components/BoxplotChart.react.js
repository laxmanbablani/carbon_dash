...
import { BoxplotChart as CarbonChart } from '@carbon/charts';
...
const BoxplotChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('boxplot-click', (event) => {
...
BoxplotChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
