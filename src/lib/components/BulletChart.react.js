...
import { BulletChart as CarbonChart } from '@carbon/charts';
...
const BulletChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('bullet-click', (event) => {
...
BulletChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
