...
import { ChoroplethChart as CarbonChart } from '@carbon/charts';
import '@carbon/charts/styles.css';

const ChoroplethChart = (props) => {
    const {
        id, setProps,
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('choropleth-click', (event) => {
...
ChoroplethChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
