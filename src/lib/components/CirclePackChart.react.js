...
import { CirclePackChart as CarbonChart } from '@carbon/charts';
import '@carbon/charts/styles.css';

const CirclePackChart = (props) => {
    const {
        id, setProps,
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('circle-pack-click', (event) => {
...
CirclePackChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
