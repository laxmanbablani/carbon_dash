...
import { GaugeChart as CarbonChart } from '@carbon/charts';
...
const GaugeChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('gauge-click', (event) => {
...
GaugeChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
