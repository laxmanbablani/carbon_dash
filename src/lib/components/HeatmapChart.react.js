...
import { HeatmapChart as CarbonChart } from '@carbon/charts';
...
const HeatmapChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('heatmap-click', (event) => {
...
HeatmapChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
