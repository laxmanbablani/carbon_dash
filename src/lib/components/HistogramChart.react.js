...
import { HistogramChart as CarbonChart } from '@carbon/charts';
...
const HistogramChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('histogram-click', (event) => {
...
HistogramChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
