...
import { LollipopChart as CarbonChart } from '@carbon/charts';
...
const LollipopChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('lollipop-click', (event) => {
...
LollipopChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
