...
import { MeterChart as CarbonChart } from '@carbon/charts';
...
const MeterChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('meter-click', (event) => {
...
MeterChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
