...
import { RadarChart as CarbonChart } from '@carbon/charts';
...
const RadarChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('radar-click', (event) => {
...
RadarChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
