...
import { TreeChart as CarbonChart } from '@carbon/charts';
...
const TreeChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('tree-click', (event) => {
...
TreeChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
