...
import { TreemapChart as CarbonChart } from '@carbon/charts';
...
const TreemapChart = (props) => {
    ...
    useEffect(() => {
        ...
        chartRef.current.addEventListener('treemap-click', (event) => {
...
TreemapChart.defaultProps = { data: [], options: {}, clickData: null, selectedPoint: null };
